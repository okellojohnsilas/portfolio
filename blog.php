...
<main class="container py-4">
    <div class="row g-5">
        <div class="col-md-8">
            <div class="card py-2 border-0 rounded-0 shadow-lg">
                <div class="card-header bg-transparent border-primary">
                    <h2 class="link-body-emphasis mb-1 fw-bold text-secondary text-justify">Sample blog post</h2>
                </div>
                <div class="card-body">
                    <article class="blog-post">
                        <p class="blog-post-meta fst-italic fw-bold">Posted on January 1, 2021</p>
                        ...
                        <p>This is some additional paragraph placeholder content. It has been written to fill the
                            ...
                            often
                            to keep the demonstration flowing, so be on the lookout for this exact same string of text.
                        </p>
                        <h2>Blockquotes</h2>
