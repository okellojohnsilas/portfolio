     ...
     <div class="container">
         ...
         <div class="collapse navbar-collapse" id="navbarResponsive">
             <ul class="navbar-nav ms-auto">
                 ...
                 <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="<?php print base_url();?>about"><?php echo translate_text('about', $language);?>
                     </a></li>
                 <!-- <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded"
                         href="<?php // print base_url(); ?>portfolio">Portfolio
                 </a></li> -->
                 <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="<?php print base_url();?>resume"><?php echo translate_text('resume', $language);?>
                     </a></li>
                 <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded"
                         href="<?php print base_url();?>contact"><?php echo translate_text('contact', $language);?></a></li>
                 <li class="nav-item mx-0 mx-lg-1 dropdown">
                     ...
                     <ul class="dropdown-menu">
                         <li><a class="dropdown-item" href="<?php print base_url();?>"><?php echo translate_text('English', $language);?>/English</a></li>
                         <li><a class="dropdown-item" href="<?php print base_url().'?'?>lang=es"><?php echo translate_text('Spanish', $language);?>/Spanish</a></li>
                         <li><a class="dropdown-item" href="<?php print base_url().'?'?>lang=fr"><?php echo translate_text('French', $language);?>/French</a></li>
                         <li><a class="dropdown-item" href="<?php print base_url().'?'?>lang=de"><?php echo translate_text('German', $language);?>/German</a></li>
