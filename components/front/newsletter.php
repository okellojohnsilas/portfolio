        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center pb-5">
                <div class="container">
                    ...
                    <h5 class="portfolio-modal-title text-secondary text-uppercase mb-0 text-center">GET MY FREE
                        NEWSLETTER
                    </h5>
                    <!-- Icon Divider-->
                    <div class="divider-custom">
                    ...
                    <form class="justify-content-center">
                        ...
                        <button type="submit" class="btn btn-primary fw-bold">GET
                            NOW <i class="fas fa-paper-plane"></i></button>
