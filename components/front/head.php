...
<head>
    ...
    <meta property="og:image" content="<?php print base_url().'assets/dist/front/src/img/seo/portfolio-twitter.png'; ?>">
    ...
    <meta name="twitter:description"
        content="Explore my projects, AI research, software development, and IT consulting services.">
    <meta name="twitter:image" content="<?php print base_url().'assets/dist/front/src/img/seo/portfolio-twitter.png'; ?>">
    <!-- Replace with your real image -->
